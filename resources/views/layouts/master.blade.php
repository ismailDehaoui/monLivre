...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="{{ url('/catégories') }}">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{ url('/abonnées') }}">
            ...
            <span class="nav-link-text ms-1">Les abonnées</span>
          </a>
        </li>
        <!--<li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{'/emprunts'}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="./pages/rtl.html">
            ...
            <span class="nav-link-text ms-1">Mot clé</span>
          </a>
        </li>
        <li class="nav-item">
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
      <div class="mx-3">
        <a class="btn bg-gradient-primary mt-4 w-100" href="{{ url('/') }}" type="button">Aller au site</a>
      </div>
    </div>
  </aside>
