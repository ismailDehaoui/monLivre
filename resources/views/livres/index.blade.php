...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="col-12">
            <div>
              <a class="btn btn-secondary mb-3" href="{{url('/livres/ajouter')}}">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{ asset('assets/img/livres/'.$livre->photo) }}" class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                          </div>
