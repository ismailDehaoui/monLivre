                        ...
                        <form action="{{ url('livres') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group my-3">
                                        ...
                                        <input type="text" class="form-control border border-primary" name="titre" required>
                            ...
                            <div class="form-group my-3">
                                    ...
                                    <input type="text" class="form-control border border-primary" name="isbn" required>
                            ...
                            <div class="form-group my-3">
                                    ...
                                    <input type="text" class="form-control border border-primary" name="éditeur" required>
                            ...
                            <div class="form-group my-3">
                                    ...
                                    <input type="number" min="1" name="nombre-exemplaires-disponibles" class="form-control border border-primary" required>
                        ...
                        <select id="auteur" name="auteur[]" class="form-control border border-primary" multiple required >
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-group my-3">
                                ...
                                <input type="number" min="1900" max="{{ date('Y') }}" name="année" class="form-control border border-primary">
